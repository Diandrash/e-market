    ...
    <section class="product-details pt-24 mx-4 md:mx-10 pb-24">
        <div class="product-area flex flex-wrap">
            ...
            <div class="product-detail ml-0 md:ml-10">
                ...
                <div class="product-price font-black text-3xl md:text-4xl text-emerald-600">
                ...
                <div class="order-area action-area mt-9 md:mt-36">
                    <div class="action-area">
                        <div class="flex gap-4">
                            <div class="items rounded-lg py-2 px-3 bg-amber-400 hover:bg-amber-200 flex self-center items-center cursor-pointer" onclick="location.href='/myproducts/{{ $product->id }}/edit'">
                                <img src="/icons/pencil-solid.svg" alt="" class="w-5">
                                <h1 class="font-bold text-base md:text-lg ml-3 text-white">Edit Product</h1>
                            </div>
                            <form action="/myproducts/{{$product->id}}/delete" method="post">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="items rounded-lg py-2 px-3 bg-red-600 hover:bg-red-400 flex self-center items-center cursor-pointer" onclick="confirm('Sure to Delete this Product?')">
                                    <img src="/icons/trash-solid.svg" alt="" class="w-4">
                                    <h1 class="font-bold text-base md:text-lg ml-3 text-white">Delete Product</h1>
                                </button>
                            </form>
                        </div>
                    </div>
                    <form action="" method="post">
                        ...
                        <input type="number" class="w-1/12 h-8 font-bold ml-3 pl-5" value="1" name="quantity" id="quantity"> --}}
                        <button type="submit" disabled class="w-full h-14 mt-8 bg-emerald-600 font-semibold text-white text-xl rounded-lg disabled opacity-30">
                            Buy Now
                        </button>
                    </form>
                </div>
